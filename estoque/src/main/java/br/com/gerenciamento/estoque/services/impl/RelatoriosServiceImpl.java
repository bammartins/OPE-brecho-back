    ...
    public void testeJasper(List<Acesso> acesso, String tipo) {
        try {
            ...
            if (tipo.equalsIgnoreCase("html")) {
                JasperExportManager.exportReportToHtmlFile(relatorioPreenchido, "C:\\Users\\Brally\\Desktop\\Relatorio.html");
            } else if (tipo.equalsIgnoreCase("pdf")) {
                JasperExportManager.exportReportToPdfFile(relatorioPreenchido, "C:\\Users\\Brally\\Desktop\\Relatorio.pdf");
            }
